...
const Stats = () => {
    return (
        <motion.section
            ...
            viewport={{ once: true }}
            className='grid grid-cols-1 md:grid-cols-2 gap-20 my-20 px-15 shadow-2xl mx-15 p-10 rounded-4xl bg-eh-white' >
            ...
            <div className='grid grid-cols-1 md:grid-cols-2'>
                {statsData.map((stats, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-4xl font-bold text-eh-primary mb-2">
