...
export default function SubHeader() {
  ...
  return (
    <div className="relative w-full pt-[150px] pb-[50px] flex items-center justify-center bg-cover bg-center bg-no-repeat  px-10 md:px-15" style={{ backgroundImage: "url('/image1.jpg')" }}>
        ...
        <div className="z-10 w-full h-full flex flex-col items-center justify-center gap-2">
            <h2 className="text-white text-4xl font-extrabold capitalize">{title}</h2>
